<!--
    ...
    @pageCreated :  2020-3-22 15:53:18
-->

<template src="./show-home-page.html">
</template>
...
<script lang="ts">
    ...
    export default class extends Vue {
        ...
        mounted(){
            ...
            if(this.baseInfo.webTitle){
              (document.querySelector("title") as any).innerText=this.baseInfo.webTitle;
            }
        }
        footerValueKeyList=[
            {icon:"email",k:"email"},
